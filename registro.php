        ...
        <div class="header-body text-center mb-4">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-white">Registro al sistema</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-header bg-transparent pb-3">
              <div class="text-muted text-center mt- mb-3"><small>Regístrate con</small></div>
              ...
              <form role="form">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                      ...
                      <input class="form-control" placeholder="Fecha de nacimiento" type="text" value="">
                  </div>
                ...
                <div class="col-12">
                  <div class="custom-control custom-control-alternative custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheckRegister">
                      <span class="text-muted">Aceptar los <a href="#!">términos y condiciones</a></span>
                    </label>
                  </div>
                </div>
              </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="index.php" class="text-light"><small>¿Ya tienes una cuenta?</small></a>
            </div>
          </div>
        </div>
      </div>
