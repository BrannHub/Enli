...
<script src="vendor/js/arrive.min.js"></script>
<script src="vendor/js/dash.min.js"></script>
<script src="vendor/js/jasny.min.js"></script>
<script src="vendor/js/material.min.js"></script>
<script src="vendor/js/moment.js"></script>
<script src="vendor/js/noti.js"></script>
<script src="vendor/js/scroll.min.js"></script>
<script src="vendor/js/select-picker.min.js"></script>
<script src="vendor/js/selectpicker.js"></script><!-- NO SON IGUALES -->
